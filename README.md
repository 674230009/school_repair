...
ทุกบัญชีใช้รหัสผ่านเดียวกันคือ: `123456`

| บทบาท (Role) | ชื่อผู้ใช้งาน (Username) | รหัสผ่าน (Password) | คำอธิบาย |
| :--- | :--- | :--- | :--- |
| **Admin** | `admin` | `123456` | สิทธิ์สูงสุด ดูงานทั้งหมด มอบหมายช่างได้ |
| **Teacher** | `teacher1` | `123456` | ครูสมชาย (แจ้งซ่อมและติดตามงานของตนเอง) |
| **Teacher** | `teacher2` | `123456` | ครูวิภา (แจ้งซ่อมและติดตามงานของตนเอง) |
| **Technician** | `tech1` | `123456` | ช่างประเสริฐ (ดูงานที่ได้รับมอบหมาย & อัปเดตการซ่อม) |
| **Technician** | `tech2` | `123456` | ช่างสมศักดิ์ (ดูงานที่ได้รับมอบหมาย & อัปเดตการซ่อม) |
